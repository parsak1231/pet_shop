...
<!-- Mirrored from mahdghanon.ir/pet-home/pet-home/Index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Nov 2024 07:31:07 GMT -->
<head>
                ...
                <div class="container p_relative h86">
                    ...
                    <div class="m_login d-flex">
                        ...
                        <div class="login px-4 py-2 radius55 d-flex align-items-center">
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.4399 19.05L15.9599 20.57L18.9999 17.53" stroke="white" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path
    ...
    <div class="container p-0 my-2">
        <div class="row">
            ...
            <div class="col-md-4 p-3">
                <div
                    class="py-4 p-3 d-flex align-items-center justify-content-around algin text-lg-right text-md-center mb-3 service_style category-style radius30">
                        ...
                        <div id="owl-Story" class="owl-carousel owl-theme text-center py-2 px-md-3">
                            <div class="item">
                                <div
                                    ...
                                    <div class="m-2">
                                        <p> این یک نوشته آزمایشی است که به طراحان و برنامه نویسان کمک میکند تا این
                                            عزیزان با بهره گیری از این نوشته تستی و آزمایشی بتوانند نمونه تکمیل شده از
                                            پروژه و طرح خودشان را به کارفرما نمایش دهند.
                                        </p>
                                        ...
                                        <div class="pt-2">
                                            ...
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#FDC736" stroke-width="1.5" stroke-linecap="round"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card p-3 mb-3 carding-blog overlyblog">
                            ...
                            <div class="p_relative">
                                <h5 class="mt-5 YekanBakhFaNum-Bold"><a href="page-blog.html">بازی با حیوانات خانگی</a>
                                </h5>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card p-3 mb-3 carding-blog overlyblog">
                            ...
                            <div class="p_relative">
                                <h5 class="mt-5 YekanBakhFaNum-Bold"><a href="page-blog.html">تغذیه ی حیوانات خانگی</a>
                                </h5>
                                <div class="d-flex justify-content-center">
                                    <a class="cateblog d-flex justify-content-center align-items-center"
                                       href="page-blog.html">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card p-3 mb-3 carding-blog overlyblog">
                            ...
                            <div class="p_relative">
                                <h5 class="mt-5 YekanBakhFaNum-Bold"><a href="page-blog.html">رفتار کودک با حیوان
                                        خانگی</a></h5>
                                <div class="d-flex justify-content-center">
                                    <a class="cateblog d-flex justify-content-center align-items-center"
                                       href="page-blog.html">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card p-3 mb-3 carding-blog overlyblog">
                            ...
                            <div class="p_relative">
                                <h5 class="mt-5 YekanBakhFaNum-Bold"><a href="page-blog.html">تربیت حیوانات خانگی</a>
                                </h5>
                                <div class="d-flex justify-content-center">
                                    <a class="cateblog d-flex justify-content-center align-items-center"
                                       href="page-blog.html">
    ...
    <footer class="footer-parent pt-4 pb-4">
        <div class="container footer-wrap">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex align-items-center my-3">
                                <svg width="22" height="21" viewBox="0 0 22 21" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.353 1C17.054 1.411 19.978 4.331 20.393 8.032" stroke="#FFB500"
            ...
            <div class="d-flex align-items-center justify-content-between copyright py-3 px-5 radius30">
                ...
                <div class="">
                    <p class="text-center fa14">کلیه حقوق مادی و معنوی این قالب برای توسعه دهندگان آن محفوظ بوده و
                        هرگونه کپی برداری، پیگرد قانونی دارد.</p>
                </div>
...
<!-- Mirrored from mahdghanon.ir/pet-home/pet-home/Index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Nov 2024 07:31:16 GMT -->
</html>
